"""Run the public source-free QDMR-like question-planner gate."""
...
from fvsc.evaluation.question_planner import QUESTION_PLANNER_PROMPT_VERSION
...
def main(argv=None) -> int:
    ...
    if output.exists() or not output.parent.is_dir():
        raise ValueError("question-planner output path must be new with an existing parent")
    ...
    generations = run_question_planner(
    ...
    artifact = {
        ...
        "prompt_version": QUESTION_PLANNER_PROMPT_VERSION,
        "seed": args.seed,
        "temperature": 0.0,
    }
    output.write_text(
